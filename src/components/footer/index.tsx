...
const Footer: React.FC = () => {
  ...
  return (
    <footer className={style.footer}>
      <div className={`${style.wrap} page-width`}>
        <p className={style.copy}>{locales.footer.copy_right}</p>
        <ul className={style.nav}>
          ...
          <li className={style.item}>
            <a className={style.elem} target="_blank" rel="noreferrer" href="https://github.com/Smd16Bi" title="github">
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
